...
if (menu == "+") {
    ...
    console.log("Hasil tambah", nilai1, "+", nilai2, "adalah", fg_int_tambah(nilai1, nilai2));
    let menu = prompt("Masukkan Menu(+|-|/|*|%|stop): ");
} else if (menu == "-") {
    let nilai1 = parseInt(prompt("nilai 1= "));
    let nilai2 = parseInt(prompt("nilai 2= "));
    fg_int_kurang(nilai1, nilai2)
    console.log("Hasil kurang", nilai1, "-", nilai2, "adalah", fg_int_kurang(nilai1, nilai2));
    let menu = prompt("Masukkan Menu(+|-|/|*|%|stop): ");
} else if (menu == "/") {
    let nilai1 = parseInt(prompt("nilai 1= "));
    let nilai2 = parseInt(prompt("nilai 2= "));
    ...
    console.log("Hasil kali", nilai1, "*", nilai2, "adalah", fg_int_kali(nilai1, nilai2));
    let menu = prompt("Masukkan Menu(+|-|/|*|%|stop): ");
} else if (menu == "%") {
    let nilai1 = parseInt(prompt("nilai 1= "));
    let nilai2 = parseInt(prompt("nilai 2= "));
    fg_int_sisabagi(nilai1, nilai2)
    console.log("Hasil sisabagi", nilai1, "%", nilai2, "adalah", fg_int_sisabagi(nilai1, nilai2));
    let menu = prompt("Masukkan Menu(+|-|/|*|%|stop): ");
} else {
